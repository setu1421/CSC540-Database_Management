...
CREATE TABLE RERULE(
	...
	CONSTRAINT FK_BCODE_RE FOREIGN KEY (BRANDID) REFERENCES BRAND(BID),
...
CREATE TABLE LOYALTYPROGRAM(
	...
	CONSTRAINT FK_LP FOREIGN KEY (BRANDID) REFERENCES BRAND(BID)
);
...
CREATE TABLE WALLET_RR(
    SER NUMBER(10) GENERATED ALWAYS as IDENTITY(START with 1 INCREMENT by 1), 
	CUSTOMERID VARCHAR2(50),
	BID VARCHAR2(50),
	REWARDCODE  VARCHAR2(10),
    POINTREEDEM FLOAT(10),
	DATEOFACTIVITY DATE, 
	...
	CONSTRAINT fk_customerwalletRR FOREIGN KEY (CUSTOMERID) REFERENCES CUSTOMER(CUSTOMERID)
);

/*
CREATE TABLE WALLET_EARNING(
...
CREATE TABLE GIFTCARD(
	...
	CONSTRAINT PK_GIFTCARD PRIMARY KEY (GCID) 	
);

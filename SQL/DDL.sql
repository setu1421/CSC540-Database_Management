...
CREATE TABLE RRRULE(
	...
	BRANDID VARCHAR2(50),
	CONSTRAINT PK_RRRULE primary key(LPCODE, REWARDCODE, VERSIONNO),
	CONSTRAINT FK_RRCODE FOREIGN KEY (REWARDCODE) REFERENCES REWARDTYPE(REWARDCODE),
	CONSTRAINT FK_BCODE_RR FOREIGN KEY (BRANDID) REFERENCES BRAND(BID)
);
...
CREATE TABLE RERULE(
	...
	BRANDID VARCHAR2(50),
	--LPCODE VARCHAR2(50),
	CONSTRAINT PK_RERULE primary key(LPCODE, ACTIVITYCODE, VERSIONNO),

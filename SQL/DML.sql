...
INSERT INTO BRAND VALUES ('Brand03', 'Uber Technologies, Inc.', 'San Francisco, CA', '01-JAN-2021');
INSERT INTO BRAND VALUES ('Brand02', 'Foodlion, Inc.', 'San Francisco, CA', '01-JAN-2021');
select * from brand;
...
INSERT INTO GIFTCARD(BID, QUANTITY, EXPIRY) VALUES ('Brand03', 25, '01-JAN-2023');
INSERT INTO GIFTCARD(BID, QUANTITY, EXPIRY) VALUES ('Brand02', 25, '01-JAN-2022');
SELECT * FROM GIFTCARD;


--INSERT INTO FREE PRODUCT
INSERT INTO FREEPRODUCT (FPRODNAME, BID, QUANTITY) VALUES ('LAPTOP', 'Brand03', 5);
INSERT INTO FREEPRODUCT (FPRODNAME, BID, QUANTITY) VALUES ('IPHONE', 'Brand02', 10);
SELECT * FROM FREEPRODUCT; 


-- Insert into RE rules 
INSERT INTO RERULE VALUES (1, 50, 'A01', 'Brand03');
INSERT INTO RERULE VALUES (1, 50, 'A02', 'Brand02');
select* from rerule;


-- Insert into rr rules 
INSERT INTO RRRULE VALUES (1, 100, 'R01', 20, 'Brand03'); 
INSERT INTO RRRULE VALUES (1, 500, 'R02', 50, 'Brand02'); 
select* from rrrule;
...
-- INSERT INTO TIER
INSERT INTO TIER VALUES('BRONZE', 0, 1, 'TLP01');
INSERT INTO TIER VALUES('SILVER', 170, 2, 'TLP01');
INSERT INTO TIER VALUES('GOLD', 270, 3, 'TLP01');
SELECT * FROM TIER;


--insert into brand activity type
INSERT INTO BRANDACTIVITYTYPE VALUES('Brand03', 'A01');
INSERT INTO BRANDACTIVITYTYPE VALUES('Brand02', 'A02');
select * from BRANDACTIVITYTYPE;


--insert into brand REWARD type
INSERT INTO BRANDREWARDTYPE VALUES('Brand03', 'R01', 500);
INSERT INTO BRANDREWARDTYPE VALUES('Brand02', 'R02', 1000);
select * from BRANDREWARDTYPE;



-- Insert into customer table
INSERT INTO CUSTOMER VALUES('C0001', 'Peter', 'Parker', '8636368778', '20 Ingram Street, NY', 'W0001');
INSERT INTO CUSTOMER VALUES('C0002', 'Steve', 'Rogers', '8972468552', '569 Leaman Place, NY', 'W0002');
select * from customer;


--INSERT INTO ENROL LP
INSERT INTO ENROLLP VALUES('C0001', 'RLP02', 200, '01-JAN-2021');
INSERT INTO ENROLLP VALUES('C0002', 'TLP01', 450, '01-JAN-2021');
SELECT * FROM ENROLLP;
